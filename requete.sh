...
mysql -h 127.0.0.1 -P 3307 -u root -p'root' GestionParc -e "SELECT * FROM data WHERE marque='Hp';"
...
mysql -h 127.0.0.1 -P 3307 -u root -p'root' GestionParc -e "SELECT * FROM data WHERE DateAchat BETWEEN '2023-03-01' AND '2023-08-30';"
...
mysql -h 127.0.0.1 -P 3307 -u root -p'root' GestionParc -e "SELECT * FROM data WHERE marque='Hp' AND DateAchat BETWEEN '2023-05-01' AND '2023-08-30';"
...
mysql -h 127.0.0.1 -P 3307 -u root -p'root' GestionParc -e "SELECT COUNT(*) FROM data WHERE marque='Dell';"
...
mysql -h 127.0.0.1 -P 3307 -u root -p'root' GestionParc -e "SELECT * FROM data WHERE RamGB BETWEEN '4' AND '8';"
...
mysql -h 127.0.0.1 -P 3307 -u root -p'root' GestionParc -e "SELECT LogInst FROM data WHERE Id='12';"
...
mysql -h 127.0.0.1 -P 3307 -u root -p'root' GestionParc -e "SELECT DISTINCT LogInst FROM data WHERE user='James Harper';"
...
mysql -h 127.0.0.1 -P 3307 -u root -p'root' GestionParc -e "SELECT DISTINCT user FROM data WHERE marque='Hp';"
...
mysql -h 127.0.0.1 -P 3307 -u root -p'root' GestionParc -e "SELECT DISTINCT user FROM data WHERE marque='Hp' AND OS='Windows10';"
...
mysql -h 127.0.0.1 -P 3307 -u root -p'root' GestionParc -e "SELECT PcInter FROM technicien WHERE DateInter BETWEEN '2023-10-10' AND '2023-12-10';"
...
mysql -h 127.0.0.1 -P 3307 -u root -p'root' GestionParc -e "SELECT PcInter FROM technicien WHERE NomTech='Jorlive Missilou';"
...
mysql -h 127.0.0.1 -P 3307 -u root -p'root' GestionParc -e "SELECT PcInter FROM technicien WHERE NomTech='Alexandre PP';"
